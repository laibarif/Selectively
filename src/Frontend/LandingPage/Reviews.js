  ...
  return (
    <div className="relative py-28 bg-yellow-50">
      <img
        src={plant}
        alt="Plant"
        className="absolute hidden sm:block  sm:top-48 left-40    w-24 h-28"
      />
      <img
        src={star}
        alt="Stars"
        className="absolute top-56 right-10 sm:top-56 sm:right-48 w-28 h-36"
      />
      <div className=" py-12">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            ...
            <div className="bg-gray-300 rounded-lg shadow-md p-6 max-w-sm transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-gray-300">
              <p className="text-gray-700 text-lg italic">
                "I love that it's an impartial true representation of your
                child's abilities."
              </p>
            ...
            <div className="bg-gray-300 rounded-lg shadow-md p-6 max-w-sm transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-gray-300">
              <p className="text-gray-700 text-lg italic">
                "Great resource. Focus tests and ICAS-style tests mean we're
                able to work on each skill individually once a weakness is
                identified."
              </p>
